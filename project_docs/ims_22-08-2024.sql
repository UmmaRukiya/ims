...
(17, 1, '6', 5, NULL, 1, 1, '30.00', '20.00', '0.00', '33.00', '2024-08-22 06:32:04', 1, NULL, NULL, NULL),
(18, 2, '6', 5, NULL, 1, 1, '25.00', '20.00', '0.00', '33.00', '2024-08-22 06:32:04', 1, NULL, NULL, NULL),
(19, 3, '6', 5, NULL, 1, 1, '25.00', '23.00', '0.00', '33.00', '2024-08-22 06:32:04', 1, NULL, NULL, NULL),
(20, 4, '6', 5, NULL, 1, 1, '21.00', '15.00', '0.00', '33.00', '2024-08-22 06:32:04', 1, NULL, NULL, NULL);
...
INSERT INTO `student_fees` (`id`, `student_id`, `session_id`, `class_id`, `group_id`, `amount`, `total_amount`, `discount`, `pay`, `fees_month`, `fees_year`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted_at`) VALUES
(1, '1', 1, 5, 1, '1200.00', 1200, '0.00', '900.00', 1, 2024, '2024-08-22 06:48:05', 1, '2024-08-22 07:10:46', 1, NULL),
(3, '1', 1, 5, 1, '1200.00', 1140, '60.00', '1140.00', 2, 2024, '2024-08-22 07:10:18', 1, '2024-08-22 07:10:36', 1, NULL);
...
CREATE TABLE `student_fees_details` (
  ...
  `fees_category_id` int(11) DEFAULT NULL,
  `amount` decimal(10,2) DEFAULT NULL,
  `fees_month` varchar(2) DEFAULT NULL,
  `fees_year` year(4) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `created_by` int(11) DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
...
INSERT INTO `student_fees_details` (`id`, `student_fees_id`, `fees_category_id`, `amount`, `fees_month`, `fees_year`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted_at`) VALUES
(1, 1, 1, '500.00', '01', 2024, '2024-08-22 06:48:05', 1, NULL, NULL, NULL),
(2, 1, 2, '700.00', '01', 2024, '2024-08-22 06:48:05', 1, NULL, NULL, NULL),
(3, 3, 1, '500.00', '02', 2024, '2024-08-22 07:10:18', 1, NULL, NULL, NULL),
(4, 3, 2, '700.00', '02', 2024, '2024-08-22 07:10:18', 1, NULL, NULL, NULL);
