...
<body>
    ...
    <?php 
        $olddata=array();
        $con['id']=$_GET['id'];
        $result=$mysqli->common_select_single('teacher_attendance','*',$con);
        if($result){
            if($result['data']){
                $olddata=$result['data'];
            }
    ...
    ?>
            <form method="post" action="">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="teacher_id" class="form-control" id="teacher_id" placeholder="teacher id no." value="<?= $olddata->teacher_id ?>">
                    </div>
                    <div class="col-md-6">
            ...
            <?php 
                if($_POST){
                    ...
                    $_POST['updated_by']=1;
                    $rs=$mysqli->common_update('teacher_attendance',$_POST,$con);
                    if($rs){
                        if($rs['data']){
